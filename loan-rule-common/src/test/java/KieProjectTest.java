import com.virgo.finance.loan.rule.common.utils.FileUtil;
import com.virgo.finance.loan.rule.common.utils.KieProjectUtil;
...
//        Resource resource = kieServices.getResources().newReaderResource( new StringReader( drl), "UTF-8" );
        Resource resource = ResourceFactory.newFileResource("D:/doc/loan_my/rules/test.drl"); // 读本地文件
//        resource = ResourceFactory.newClassPathResource("rules/contract_rule.drl"); // 本地不可读
        ...
        String kmodule = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "  </kbase>\n" +
                "</kmodule>";
        kmodule = FileUtil.readFileToString("D:/doc/loan_my/rules/kmodule.xml");
